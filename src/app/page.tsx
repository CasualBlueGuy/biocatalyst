      ...
      <header className="sticky top-0 z-50 bg-white/80 backdrop-blur border-b border-slate-200">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          <a href="#home" className="flex items-center gap-3">
            <svg aria-hidden="true" viewBox="0 0 64 64" className="h-8 w-8 fill-green-600">
          ...
          <div className="grid lg:grid-cols-2 gap-10 items-center">
            <div>
              <h1 className="text-4xl sm:text-5xl font-extrabold tracking-tight text-slate-900">
                Curiosity in <span className="text-green-700">biochemistry</span>
              </h1>
            ...
            <div className="relative">
              <div className="aspect-square rounded-2xl bg-green-50 border border-green-200 flex items-center justify-center">
                <svg aria-hidden="true" viewBox="0 0 64 64" className="h-40 w-40 fill-green-700">
                  <path d="M24 6h16v4h-2v12.6l11.2 18.5A10 10 0 0 1 39.6 56H24.4A10 10 0 0 1 14.8 41.1L26 22.6V10h-2z"/>
                  <path d="M39 10c5.5 0 9 3.8 10 8-3.7.3-7.2-1.6-9.1-4.8-.9 2.3-2.3 4-4.9 4-1.1-4.6 1.9-7.2 4-7.2z"/>
                </svg>
              </div>
      ...
      <section id="mission" className="bg-slate-50 border-y border-slate-200">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16">
          ...
          <div className="mt-10 grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              { title: "Hands-on Experiment Kits", desc: "5–7 safe, low-cost activities (DNA extraction, enzyme tests) designed for classrooms and clubs." },
              { title: "Chapter-based Impact", desc: "Templates and training to launch local chapters, recruit volunteers, and scale across schools." },
              { title: "Mentorship & Pathways", desc: "Office hours, resources, and guidance for internships, research, and college readiness." }
            ].map((f) => (
      ...
      <section id="resources">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16">
          ...
          <div className="mt-8 grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              { title: "Safety & Lab Basics", desc: "PPE, disposal, and classroom-safe handling of reagents." },
      ...
      <section id="contact" className="bg-slate-50 border-y border-slate-200">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16">
          <div className="max-w-2xl">
            ...
            <p className="mt-2 text-slate-600">Questions or want to partner? Send us a note.</p>
          </div>
          <form
            className="mt-8 grid gap-4 max-w-2xl"
            action="https://formspree.io/f/xjkozaly"
            method="POST"
            acceptCharset="UTF-8"
          >
            <input type="text" name="_gotcha" className="hidden" tabIndex={-1} autoComplete="off" />
            <input type="hidden" name="_subject" value="BioCatalyst website contact" />
            <div className="grid sm:grid-cols-2 gap-4">
              <input className="rounded-xl border border-slate-300 px-4 py-3 focus:outline-none focus:ring-2 focus:ring-green-500" type="text" name="name" placeholder="Your name" required />
              <input className="rounded-xl border border-slate-300 px-4 py-3 focus:outline-none focus:ring-2 focus:ring-green-500" type="email" name="email" placeholder="Your email" required />
            </div>
            <textarea className="rounded-xl border border-slate-300 px-4 py-3 h-32 focus:outline-none focus:ring-2 focus:ring-green-500" name="message" placeholder="How can we help?" required />
            <button type="submit" className="rounded-full bg-slate-900 text-white px-5 py-3 font-medium hover:bg-slate-800">
              Send Message
            </button>
